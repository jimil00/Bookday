...
> 책하루는 나만의 독서 노트를 기록할 수 있으며, 독서 기록에 대한 통계를 한눈에 확인할 수 있습니다. 또한 종이책을 선호하는 사용자를 위해 종이책 배송 대여 서비스를 제공하는 웹사이트입니다.

## 개요
> 수행 기간: 2022년 12월 12일~2023년 01월 05일<br>
수행 인원: 3명
...
[2. 구현 기능](#구현-기능)   
[3. 담당 역할](#담당-역할)   
[4. 프로젝트 설명](#프로젝트-설명)<br>
[5. 프로젝트 참여 소감](#프로젝트-참여-소감)
...
+ **국립중앙정보도서관 Open API를 활용한 책 데이터 수집**
...
## 담당 역할
+ 서버 구축 및 DB 관리
+ [국립중앙정보도서관 Open API를 활용한 책 데이터 수집](#국립중앙정보도서관-Open-API를-활용한-책-데이터-수집---담당)
+ [마이 페이지(회원 정보, 구독권 정보 출력)](#마이-페이지---회원-정보-구독권-정보-출력-담당)
+ [검색 페이지](#검색-페이지---담당)
+ [결제 페이지](#결제-페이지---담당)
...
### [국립중앙정보도서관 Open API를 활용한 책 데이터 수집] - 담당
```
...
## 프로젝트 참여 소감
> 이번 프로젝트에서는 사전 조사를 충분히 한 덕분에 담당한 기능을 계획했던 일정보다 빠르게 완성할 수 있었습니다. 이 덕분에 다른 팀원들도 도울 수 있었습니다. 또한, 이번 프로젝트를 통해 스프링 MVC 구조, Ajax, JSTL 등 이전에 헷갈렸던 기술들을 정리하고, 장바구니 페이지의 구성과 흐름, 다양한 기능을 습득할 수 있어서 즐거웠습니다. 그러나 기능 구현에만 치중하여 중간 점검이라는 기본적인 절차를 놓치는 실수를 했었습니다. 프로젝트를 진행하면서, 서버에서 프로젝트를 구동시켜 보지 않았기 때문에 최종 발표 직전에 일부 기능이 작동하지 않아 다급하게 수정해야 했던 경험이 있었습니다. 이 경험을 통해 중간 점검과 피드백 과정의 중요성을 다시 한번 깨닫게 되었습니다. 다음 프로젝트에서는 미리 중간 점검 날짜를 정해놓고 프로젝트를 진행할 계획입니다.
